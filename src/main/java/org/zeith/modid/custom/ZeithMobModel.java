...
public class ZeithMobModel extends EntityModel<ZeithMob> {
    ...
    public ZeithMobModel(ModelPart root) {
    ...
    @Override
    public void setupAnim(ZeithMob mob, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
